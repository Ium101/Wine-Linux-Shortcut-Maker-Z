...
class LinuxShortcutMaker:
    def __init__(self, root):
        ...
        # --- NEW: Carregar Ícone Customizado na Janela ---
        try:
            # Aponta para o diretório de ícones onde o instalador copiou a imagem .png
            ...
            pass # Falha silenciosamente se o Tkinter não achar um .png
